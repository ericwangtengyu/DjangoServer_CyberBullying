...
urlpatterns = patterns('',
	...
	url(r'^(?i)surveyiphoneloginbackend/$', views.surveyIphoneBackend, name= "surveyiphoneloginbackend"),
	url(r'^(?i)surveyphonebackend/$',           views.surveyPhoneBackend, name= "surveyphonebackend"),
	...
	url(r'^(?i)webwithdraw/$',		    views.web_withdraw, name="webwithdraw"),
	url(r'^(?i)webwithdrawbackend/$',	views.web_withdraw_backend, name="webwithdrawbackend"),
)
